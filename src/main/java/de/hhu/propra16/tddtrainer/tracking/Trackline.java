...
public class Trackline {
	...
	static Label snapInfo = new Label();
    ...
    public static void popup(TrackingManager trackingManager) {
        ...
        vbox.getChildren().addAll(header, hbox, snapInfo, closeButton);
    	...
    	private static HBox generateTrackline(TrackingManager trackingManager) {
    		...
    		for (int i = 0; i<size; i++) {
				...
				MyRectangle rectangle = new MyRectangle((timeOfSnap/(double) totalWorktime)*400.0, 50.0, trackingManager.progress.get(i));
